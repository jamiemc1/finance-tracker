...
SEED_RULES: list[tuple[str, CategoryType]] = [
    ...
    ("MCDONALD", CategoryType.EATING_OUT),
    ("BURGER KING", CategoryType.EATING_OUT),
    ("KFC", CategoryType.EATING_OUT),
    ("SUBWAY", CategoryType.EATING_OUT),
    ("PIZZA HUT", CategoryType.EATING_OUT),
    ("DOMINO", CategoryType.EATING_OUT),
    ("WAGAMAMA", CategoryType.EATING_OUT),
    ("FIVE GUYS", CategoryType.EATING_OUT),
    # Shopping
